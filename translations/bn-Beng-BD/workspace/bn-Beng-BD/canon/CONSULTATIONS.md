...
References are a working usage canon, not a claim of national-standard certification. All 21 reference HTML pages were downloaded with SHA-256 receipts; they are readable as UTF-8 text under ignored `downloads/bn-Beng-BD/canon`. There are 25 consultation examples in `register.json`. Native HTML needs no OCR. Two discovered PDFs were not used: one could not be downloaded, and the other was not trusted from its snippet. Acquire and OCR any PDF before future reliance.
...
## New reading-edition visual QA, 2026-08-31

Read BD16.txt lines 38-53 again, including the complete ৯.২.১/৯.২.২ carrying and non-carrying outcomes, while inspecting the new lesson print/screen pages. Read BD18.txt line 38's full boundary-length definition and a+b+c explanation while checking the child perimeter answer. The rendered wording retains হাতে রাখা with explicit place-value exchanges and পরিসীমা with length units, not square units. Both introduction editions and all nine child-lesson PDF pages are now directly inspected; preface and full-source/answer-key review continues. Only actual inspected page hashes are entered in the visual receipts. No new canon fetch, embedded reference image or un-OCRed reference PDF was used.

## Subtraction reference acquisition, 2026-09-01

Acquired and read the complete local text extractions for BD19–BD21 before drafting m81245. BD19 is a Grade 3 lesson locator that places বিয়োজন, বিয়োজ্য and বিয়োগফল together on pages 30–31; HTML SHA-256 `1a7628dc99c606bf31e424fa31893d2be487f41df8d95ac4f81a4fee50209ab0`, normalized text SHA-256 `824ec2e118e5317975f1a22d33eccc139e833ba1c0c6ab0c887b11cd1f09b618`. BD20's visible Grade 3 outcomes use the same three terms and state that subtraction is the inverse process of addition; HTML SHA-256 `fa9a1dc6d4504a76c0bd06445f1369bb79c9aace332631510bafdee8b17da471`, text SHA-256 `7321feec289d840b4402e10ab2e5bad47635767d4be3ca0b757cd4b034a35810`. BD21 links ধার করা বিয়োগ to place value; HTML SHA-256 `6addf6e772fc86ecd9da0d04ed94ea81818629bb13dc17fe54ec8f43d164f038`, text SHA-256 `7ca703bd7f205af4c87a2055b13e86a5214c738ff453a5b69731935c83271c1f`.

Use the locally evidenced classroom names, but define their roles from the frozen mathematics: in `a − b = c`, `a` is বিয়োজন, `b` is বিয়োজ্য and `c` is বিয়োগফল. The acquired HTML lists the names but does not itself map each name to an operand, so it is not used as mathematical proof. Pair the familiar ধার wording with an explicit value-preserving exchange from the next higher place; do not teach borrowing as an unexplained digit-crossing trick. Embedded video, presentation and document are not claimed inspected, and no NCTB or native-teacher approval is inferred.

## Subtraction notation and block-model drafting/revision/QA, 2026-09-01

Read the canonical and Indonesian m81245 passages through `fs-id1824154`, then re-read BD01.txt lines 39–55 and BD21.txt lines 39–45 during revision. BD01 explicitly builds ten-item groups with blocks/sticks and names ones/tens/hundreds; BD21 ties subtraction borrowing to place value. Apply these only to the source's own models: use এককের ব্লক and দশকের দণ্ড, and say that one tens rod is exchanged for ten ones without changing the represented value. BD20's inverse-operation outcome was also re-read, but it belongs to the next source section and was not inserted early.

Directly inspected all 19 new block-model images. The source alt for figure 007 repeats 9 − 6 although the image and problem show 6 − 1 = 5; the translated description follows the visible image. Figure 020_img-04 actually circles eight of thirteen ones and leaves five, not ten circled/four extra as its source alt says. Figures 018 use pale blue rather than grey. Correct only translated text alternatives; preserve every original image byte and source MathML. The three model tables declare three columns but contain two meaningful cells per row, so semantic HTML uses two labelled columns while CNXML structure stays unchanged. This is AI-assisted source QA, not teacher or browser approval.
