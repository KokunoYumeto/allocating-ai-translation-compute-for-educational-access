// Author-only local render. Browser skill setup/selection found no connected
// browser. No browser was user-specified; this isolated Edge has no signed-in profile.
